                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="name" type="text"
                            class="form-control @error('name') is-invalid @enderror samuraimart-login-input" name="name"
                            value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="侍 太郎">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text"
                            ...
                            name="postal_code" required placeholder="150-0043">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text"
                            ...
                            name="address" required placeholder="東京都渋谷区道玄坂２丁目１１−１">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text"
                            ...
                            name="phone" required placeholder="03-5790-9039">
                    </div>
                </div>
